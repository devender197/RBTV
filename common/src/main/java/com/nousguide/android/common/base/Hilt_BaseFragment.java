 ...
 */
public abstract class Hilt_BaseFragment extends Fragment implements GeneratedComponentManagerHolder {
  ...
  Hilt_BaseFragment(int contentLayoutId) {
  ...
  protected void inject() {
    if (!injected) {
      injected = true;
      ((BaseFragment_GeneratedInjector) this.generatedComponent()).injectBaseFragment(UnsafeCasts.<BaseFragment>unsafeCast(this));
    }
  }
